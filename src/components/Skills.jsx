            ...
            <div className="max-w-screen-lg md:h-[91vh] mx-auto py-10 px-6">
                ...
                <div className="grid place-items-center w-full h-full">
                    <div className="grid grid-cols-2 md:grid-cols-3 place-items-center gap-5" title='I have 3 years+ experiece'>
                        <div className="outline-dashed outline-1 outline-slate-500 transition hover:outline rounded-sm p-3">
                        ...
                        <div className="outline-dashed outline-1 outline-slate-500 transition hover:outline rounded-sm p-3" title='I have 3 years+ experiece'>
                            <div className="flex justify-between items-center">
                                <TbBrandCss3 size={30} />
                                <h4>CSS</h4>
                            </div>
