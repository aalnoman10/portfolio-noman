                ...
                <div className="grid place-items-center w-full h-full">
                    <div className="grid grid-cols-1 md:grid-cols-3 place-items-center gap-5" title='I have 3 years+ experiece'>
                        ...
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3" title='I have 3 years+ experiece'>
                            ...
                            <progress className="progress progress-primary w-60" value="65" max="100"></progress>
                        </div>
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            <div className="flex justify-between items-center">
                            ...
                            <progress className="progress progress-primary w-60" value="75" max="100"></progress>
                        </div>
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            <div className="flex justify-between items-center">
                            ...
                            <progress className="progress progress-primary w-60" value="70" max="100"></progress>
                        </div>
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            <div className="flex justify-between items-center">
                                <FaReact size={30} />
                        ...
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            ...
                            <progress className="progress progress-primary w-60" value="45" max="100"></progress>
                        </div>
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            <div className="flex justify-between items-center">
                            ...
                            <progress className="progress progress-primary w-60" value="57" max="100"></progress>
                        </div>
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            <div className="flex justify-between items-center">
                                <BsGit size={30} />
                            ...
                            <progress className="progress progress-primary w-60" value="55" max="100"></progress>
                        </div>
                        <div className="outline-dashed outline-1 outline-slate-500 hover:outline rounded-sm p-3">
                            <div className="flex justify-between items-center">
                                <FiGithub size={30} />
